...
<head>
    ...
    <title>Terceros | <?php echo $titulo; ?></title>

    <?php require_once '../config/links.php'; ?>

    <!-- eventos -->
    <link rel="stylesheet" href="dom/terceros.css">
...
<body class="nk-body bg-lighter npc-default has-sidebar">
                    ...
                    <div class="nk-content">
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Terceros</h3>
                                    <ul class="breadcrumb">
                            ...
                            <div class="nk-content-inner">
                                <div class="nk-content-body">
                                    <div class="nk-block bg-white mt-3 p-3 shadow">
                                        <div class="row p-3">
                                            <div class="col-sm-12" id="content_result_items"><?php tabla_terceros($conn); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="apli/terceros.js"></script>
</body>
</html>
